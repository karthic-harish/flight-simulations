...
var n = 10; // number of simulation runs + 1
...
for (var j = 8; j < 11; j++) {
 for (var i = 6; i < 16; i++) {
  left_front_wing[x] = {"location": {"row":j,"col":i}, "occupied": 0};   // left front wing
  x += 1
 };
};
...
for (var j = 8; j < 11; j++) {
 for (var i = 16; i < 26; i++) {
  left_middle_wing[x] = {"location": {"row":j,"col":i}, "occupied": 0};    // left middle wing
  x += 1
 };
};
...
for (var j = 8; j < 11; j++) {
 for (var i = 26; i < 36; i++) {
  left_back_wing[x] = {"location": {"row":j,"col":i}, "occupied": 0};    // left back wing
  x += 1
 };
};
...
for (var j = 12; j < 15; j++) {
 for (var i = 6; i < 16; i++) {
  right_front_wing[y] = {"location": {"row":j,"col":i}, "occupied": 0};   // right front wing
  y += 1
 };
};
...
for (var j = 12; j < 15; j++) {
 for (var i = 16; i < 26; i++) {
  right_middle_wing[y] = {"location": {"row":j,"col":i}, "occupied": 0};   // right middle wing
  y += 1
 };
};
...
for (var j = 12; j < 15; j++) {
 for (var i = 26; i < 36; i++) {
  right_back_wing[y] = {"location": {"row":j,"col":i}, "occupied": 0};    // right back wing
  y += 1
 };
};
...
function Reload(){
	...
	PassengerCount = 0;
	waitingtime = 0;
	allfrontseats = left_front_wing.concat(right_front_wing);
	allmiddleseats = left_middle_wing.concat(right_middle_wing);
	allbackseats = left_back_wing.concat(right_back_wing);
...
function addPassengers(){
 ...
 if (PassengerCount < 60 & aisle[0].occupied == 0) {
	 var passengerseat = randomSeat(allbackseats);
	...
	var seatindex = allbackseats.indexOf(passengerseat);
	allbackseats.splice(seatindex, 1);
	aisle[0].occupied = 1;
	PassengerCount += 1;
	console.log(1);
 ...
 if (PassengerCount == 60 & waitingtime != targetwaitingtime ) {
	 waitingtime += 1;
 };

if (PassengerCount >= 60 & PassengerCount < 120 & waitingtime == targetwaitingtime) {
	var passengerseat = randomSeat(allmiddleseats);
	 var passengerRow = Number(passengerseat.location.row);
	 var passengerCol = Number(passengerseat.location.col);
	 var newpassenger = {"location":{"row":11,"col":4},
	"target":{"row":passengerRow,"col":passengerCol},
	...
	"bagwaitcount":1, "seatmovecount": 1};
	passengers.push(newpassenger);
	var seatindex = allmiddleseats.indexOf(passengerseat);
	allmiddleseats.splice(seatindex, 1);
	aisle[0].occupied = 1;
	PassengerCount += 1;
	console.log(2);
};

 if (PassengerCount == 120 & waitingtime != targetwaitingtime2) {
	 waitingtime += 1;
 };

 if (PassengerCount >= 120 & PassengerCount < 180 & waitingtime == targetwaitingtime2) {
	var passengerseat = randomSeat(allfrontseats);
	 var passengerRow = Number(passengerseat.location.row);
	 var passengerCol = Number(passengerseat.location.col);
	 var newpassenger = {"location":{"row":11,"col":4},
	"target":{"row":passengerRow,"col":passengerCol},
	...
	"bagwaitcount":1, "seatmovecount": 1};
	passengers.push(newpassenger);
	var seatindex = allfrontseats.indexOf(passengerseat);
	allfrontseats.splice(seatindex, 1);
	aisle[0].occupied = 1;
	PassengerCount += 1;
	console.log(3);
};
